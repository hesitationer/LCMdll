...
public: //public设置之前的成员都是上面所设置的私有的
	...
	int if_show_result;
	int if_save_midlle_result;

	int A[10][20];

	string tmptxt;
	string R_difftxt; // R角diff面积记录

	string h_w_tmp_file;

	string fir_result_file;
...
public: //public设置之前的成员都是上面所设置的私有的
	...
	CanShu(int subThresh, int subBGRThresh, int bgrThresh, int hsvThresh, int sort_dxy1, int sort_dxy2, int sort_dxy3, int sort_dxy4, int houghthr, int DUSTHOLD, int DUSTSHAPE, int fill, int Rarea, int TFTHOLD_muras, int TFTHOLD_points, int i, int j)
	{

		initCanShu(subThresh,subBGRThresh,bgrThresh, hsvThresh, sort_dxy1, sort_dxy2,sort_dxy3,sort_dxy4, houghthr, DUSTHOLD,DUSTSHAPE, fill, Rarea, TFTHOLD_muras, TFTHOLD_points, i, j);

	}

	void initCanShu(int subThresh, int subBGRThresh, int bgrThresh, int hsvThresh, int sort_dxy1, int sort_dxy2, int sort_dxy3, int sort_dxy4, int houghthr, int DUSTHOLD, int DUSTSHAPE, int fill, int Rarea, int TFTHOLD_muras, int TFTHOLD_points, int i, int j)
	{
...
void getGrounpPointResult(int maxDistance, int maxNunPoint);
